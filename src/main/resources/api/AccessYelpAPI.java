...
// 	}
	...
	public static ArrayList<Restaurant> YelpRestaurantSearch(String searchTerm) {
		...
		String rating = "NULL";
		double rating_double = 69696969;
		String drivingTime = "NULL";
		int drivingTime_int = 69696969;
		...
		try {
		    ...
		    for(int i = 0; i < 20; i++) {		//change i to get desired # of search terms
		    	...
		    	if(jsonobj_1.get("rating") != null) {
		    		...
		    		rating_double = Double.parseDouble(rating);
		    	}
		    	...
		    	if(jsonobj_1.get("distance") != null) {	//yelp returns the straight line distance from tommy trojan to the 
		    		...
		    		double tempDrivingTime_double = Double.parseDouble(drivingTime);
		    		drivingTime_int = (int) Math.round(tempDrivingTime_double);
		    	}
		    	...
		    	Restaurant restaurantObj = new Restaurant(name, websiteUrl, price, fullAddress, phoneNumber, rating_double, drivingTime_int);
